...
namespace coromendal.ACN.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("MeetingAbsentauditordetails"), InstanceName("MeetingAbsentauditordetails"), TwoLevelCached]
    [ReadPermission("Administration")]
    [ModifyPermission("Administration")]
    public sealed class MeetingAbsentauditordetailsRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Name"), Column("name"), Size(100)]
        public String Name
        {
        ...
        public MeetingAbsentauditordetailsRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("[dbo].[MeetingAbsentauditordetails]")
            {
                LocalTextPrefix = "ACN.MeetingAbsentauditordetails";
            }
        }
    }
}