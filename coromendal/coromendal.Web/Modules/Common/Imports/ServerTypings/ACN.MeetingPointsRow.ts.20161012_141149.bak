...
namespace coromendal.ACN {
    ...
    export namespace MeetingPointsRow {
        ...
        ['MeetingPointsId', 'MeetingId', 'Points', 'MeetingAcnid', 'MeetingTitle', 'MeetingAuditscope', 'MeetingPeriod', 'MeetingTime', 'MeetingVenue', 'MeetingAuditor', 'MeetingAuditee'].forEach(x => (<any>Fields)[x] = x);
    }
}
