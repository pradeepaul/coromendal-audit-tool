...
(function (coromendal) {
    ...
    (function (ACN) {
        ...
        [['Title', function () { return Serenity.StringEditor; }], ['Acnid', function () { return Serenity.LookupEditor; }], ['userid', function () { return Serenity.IntegerEditor; }], ['status', function () { return Serenity.StringEditor; }], ['Qc', function () { return Serenity.LookupEditor; }], ['Keyfacts', function () { return ACN.KeyfactsEditor; }]].forEach(function (x) { return Object.defineProperty(AcnreportForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var FinalobservationForm = (function (_super) {
            __extends(FinalobservationForm, _super);
            function FinalobservationForm() {
                _super.apply(this, arguments);
            }
            FinalobservationForm.formKey = 'ACN.Finalobservation';
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var FinalobservationService;
        (function (FinalobservationService) {
            FinalobservationService.baseUrl = 'ACN/Finalobservation';
            var Methods;
            (function (Methods) {
            })(Methods = FinalobservationService.Methods || (FinalobservationService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                FinalobservationService[x] = function (r, s, o) { return Q.serviceRequest(FinalobservationService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = FinalobservationService.baseUrl + '/' + x;
            });
        })(FinalobservationService = ACN.FinalobservationService || (ACN.FinalobservationService = {}));
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ObservationmasterForm = (function (_super) {
            __extends(ObservationmasterForm, _super);
            function ObservationmasterForm() {
                _super.apply(this, arguments);
            }
            ObservationmasterForm.formKey = 'ACN.Observationmaster';
            return ObservationmasterForm;
        }(Serenity.PrefixedContext));
        ACN.ObservationmasterForm = ObservationmasterForm;
        [['ObservationmasterId', function () { return Serenity.IntegerEditor; }], ['Observationid', function () { return Serenity.IntegerEditor; }], ['AcnId', function () { return Serenity.IntegerEditor; }], ['Scope', function () { return Serenity.StringEditor; }], ['Observationtitle', function () { return Serenity.StringEditor; }], ['Observationsynopsis', function () { return Serenity.StringEditor; }], ['Detailedobservation', function () { return Serenity.StringEditor; }], ['Category', function () { return Serenity.IntegerEditor; }], ['RiskRating', function () { return Serenity.StringEditor; }], ['Agreeobservation', function () { return Serenity.IntegerEditor; }], ['Justification', function () { return Serenity.StringEditor; }], ['Suggestion', function () { return Serenity.IntegerEditor; }], ['Alternateplan', function () { return Serenity.StringEditor; }], ['Name', function () { return Serenity.StringEditor; }], ['Email', function () { return Serenity.StringEditor; }], ['Targetdate', function () { return Serenity.StringEditor; }], ['Consequence', function () { return Serenity.IntegerEditor; }], ['Likelihood', function () { return Serenity.IntegerEditor; }], ['rootList', function () { return ACN.RootcauseEditor; }], ['SuggestionList', function () { return ACN.SuggestionEditor; }]].forEach(function (x) { return Object.defineProperty(ObservationmasterForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ObservationmasterRow;
        (function (ObservationmasterRow) {
            ObservationmasterRow.idProperty = 'ObservationmasterId';
            ObservationmasterRow.nameProperty = 'Scope';
            ObservationmasterRow.localTextPrefix = 'ACN.Observationmaster';
            var Fields;
            (function (Fields) {
            })(Fields = ObservationmasterRow.Fields || (ObservationmasterRow.Fields = {}));
            ['ObservationmasterId', 'Observationid', 'AcnId', 'Scope', 'Observationtitle', 'Observationsynopsis', 'Detailedobservation', 'Category', 'RiskRating', 'Agreeobservation', 'Justification', 'Suggestion', 'Alternateplan', 'Name', 'Email', 'Targetdate', 'Consequence', 'Likelihood', 'ObservationidAcnId', 'ObservationidScope', 'ObservationidObservationtitle', 'ObservationidObservationsynopsis', 'ObservationidDetailedobservation', 'ObservationidCategory', 'ObservationidRiskRating', 'ObservationidAgreeobservation', 'ObservationidJustification', 'ObservationidSuggestion', 'ObservationidAlternateplan', 'ObservationidName', 'ObservationidEmail', 'ObservationidTargetdate', 'ObservationidConsequence', 'ObservationidLikelihood'].forEach(function (x) { return Fields[x] = x; });
        })(ObservationmasterRow = ACN.ObservationmasterRow || (ACN.ObservationmasterRow = {}));
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ObservationmasterService;
        (function (ObservationmasterService) {
            ObservationmasterService.baseUrl = 'ACN/Observationmaster';
            var Methods;
            (function (Methods) {
            })(Methods = ObservationmasterService.Methods || (ObservationmasterService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ObservationmasterService[x] = function (r, s, o) { return Q.serviceRequest(ObservationmasterService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = ObservationmasterService.baseUrl + '/' + x;
            });
        })(ObservationmasterService = ACN.ObservationmasterService || (ACN.ObservationmasterService = {}));
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var PreobservationForm = (function (_super) {
            __extends(PreobservationForm, _super);
            function PreobservationForm() {
                _super.apply(this, arguments);
            }
            PreobservationForm.formKey = 'ACN.Preobservation';
            return PreobservationForm;
        }(Serenity.PrefixedContext));
        ACN.PreobservationForm = PreobservationForm;
        [['PreobservationId', function () { return Serenity.IntegerEditor; }], ['Observationid', function () { return Serenity.IntegerEditor; }], ['AcnId', function () { return Serenity.IntegerEditor; }], ['Scope', function () { return Serenity.IntegerEditor; }], ['Observationtitle', function () { return Serenity.StringEditor; }], ['Observationsynopsis', function () { return Serenity.StringEditor; }], ['Detailedobservation', function () { return Serenity.StringEditor; }], ['Category', function () { return Serenity.IntegerEditor; }], ['RiskRating', function () { return Serenity.StringEditor; }], ['Agreeobservation', function () { return Serenity.IntegerEditor; }], ['Justification', function () { return Serenity.StringEditor; }], ['Name', function () { return Serenity.StringEditor; }], ['Email', function () { return Serenity.StringEditor; }], ['Targetdate', function () { return Serenity.StringEditor; }], ['Consequence', function () { return Serenity.IntegerEditor; }], ['Likelihood', function () { return Serenity.IntegerEditor; }], ['Status', function () { return Serenity.IntegerEditor; }], ['rootList', function () { return ACN.RootcauseEditor; }], ['SuggestionList', function () { return ACN.SuggestionEditor; }], ['Detailedobservation1', function () { return coromendal.Northwind.NotesEditor; }]].forEach(function (x) { return Object.defineProperty(PreobservationForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var PreobservationService;
        (function (PreobservationService) {
            PreobservationService.baseUrl = 'ACN/Preobservation';
            var Methods;
            (function (Methods) {
            })(Methods = PreobservationService.Methods || (PreobservationService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                PreobservationService[x] = function (r, s, o) { return Q.serviceRequest(PreobservationService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = PreobservationService.baseUrl + '/' + x;
            });
        })(PreobservationService = ACN.PreobservationService || (ACN.PreobservationService = {}));
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ScopeexcludeForm = (function (_super) {
            __extends(ScopeexcludeForm, _super);
            function ScopeexcludeForm() {
                _super.apply(this, arguments);
            }
            ScopeexcludeForm.formKey = 'ACN.Scopeexclude';
            return ScopeexcludeForm;
        }(Serenity.PrefixedContext));
        ACN.ScopeexcludeForm = ScopeexcludeForm;
        [['ExcludeId', function () { return Serenity.IntegerEditor; }], ['Scopeid', function () { return Serenity.IntegerEditor; }], ['Aodid', function () { return Serenity.IntegerEditor; }], ['AcnId', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(ScopeexcludeForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    ...
    (function (ACN) {
        var ScopeexcludeRow;
        (function (ScopeexcludeRow) {
            ScopeexcludeRow.idProperty = 'ExcludeId';
            ScopeexcludeRow.localTextPrefix = 'ACN.Scopeexclude';
            var Fields;
            (function (Fields) {
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ScopeexcludeService;
        (function (ScopeexcludeService) {
            ScopeexcludeService.baseUrl = 'ACN/Scopeexclude';
            var Methods;
            (function (Methods) {
            })(Methods = ScopeexcludeService.Methods || (ScopeexcludeService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ScopeexcludeService[x] = function (r, s, o) { return Q.serviceRequest(ScopeexcludeService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = ScopeexcludeService.baseUrl + '/' + x;
            });
        })(ScopeexcludeService = ACN.ScopeexcludeService || (ACN.ScopeexcludeService = {}));
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    ...
    (function (ACN) {
        ...
        (function (ScopeRow) {
            ...
            function getLookup() {
                return Q.getLookup('ScopeRow');
            }
            ScopeRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
            })(Fields = ScopeRow.Fields || (ScopeRow.Fields = {}));
            ['ScopeId', 'Title', 'AcnId', 'exclude', 'AcnAcnTilte', 'AcnPhaseNo', 'AcnLocation', 'AcnFromdate', 'AcnTodate', 'AcnPeriodfrom', 'AcnPeriodto', 'AcnCreationdate'].forEach(function (x) { return Fields[x] = x; });
...
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var AdminstatusvalueForm = (function (_super) {
            __extends(AdminstatusvalueForm, _super);
            function AdminstatusvalueForm() {
                _super.apply(this, arguments);
            }
            AdminstatusvalueForm.formKey = 'Administration.Adminstatusvalue';
            return AdminstatusvalueForm;
        }(Serenity.PrefixedContext));
        Administration.AdminstatusvalueForm = AdminstatusvalueForm;
        [['Adminstatusvalueid', function () { return Serenity.IntegerEditor; }], ['Value', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(AdminstatusvalueForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var AdminstatusvalueRow;
        (function (AdminstatusvalueRow) {
            AdminstatusvalueRow.idProperty = 'Adminstatusvalueid';
            AdminstatusvalueRow.nameProperty = 'Value';
            AdminstatusvalueRow.localTextPrefix = 'Administration.Adminstatusvalue';
            function getLookup() {
                return Q.getLookup('AdminstatusvalueRow');
            }
            AdminstatusvalueRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
            })(Fields = AdminstatusvalueRow.Fields || (AdminstatusvalueRow.Fields = {}));
            ['Adminstatusvalueid', 'Value'].forEach(function (x) { return Fields[x] = x; });
        })(AdminstatusvalueRow = Administration.AdminstatusvalueRow || (Administration.AdminstatusvalueRow = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var AdminstatusvalueService;
        (function (AdminstatusvalueService) {
            AdminstatusvalueService.baseUrl = 'Administration/Adminstatusvalue';
            var Methods;
            (function (Methods) {
            })(Methods = AdminstatusvalueService.Methods || (AdminstatusvalueService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                AdminstatusvalueService[x] = function (r, s, o) { return Q.serviceRequest(AdminstatusvalueService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = AdminstatusvalueService.baseUrl + '/' + x;
            });
        })(AdminstatusvalueService = Administration.AdminstatusvalueService || (Administration.AdminstatusvalueService = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    ...
    (function (Administration) {
        ...
        [['Locid', function () { return Serenity.IntegerEditor; }], ['Locname', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(LocationForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    ...
    (function (Administration) {
        ...
        (function (LocationRow) {
            LocationRow.idProperty = 'Locid';
            LocationRow.nameProperty = 'Locname';
            LocationRow.localTextPrefix = 'Administration.Location';
            var Fields;
            (function (Fields) {
            })(Fields = LocationRow.Fields || (LocationRow.Fields = {}));
            ['Locid', 'Locname'].forEach(function (x) { return Fields[x] = x; });
...
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditeeRefForm = (function (_super) {
            __extends(MasterAcnAuditeeRefForm, _super);
            function MasterAcnAuditeeRefForm() {
                _super.apply(this, arguments);
            }
            MasterAcnAuditeeRefForm.formKey = 'Administration.MasterAcnAuditeeRef';
            return MasterAcnAuditeeRefForm;
        }(Serenity.PrefixedContext));
        Administration.MasterAcnAuditeeRefForm = MasterAcnAuditeeRefForm;
        [['AcnAuditeeRefId', function () { return Serenity.IntegerEditor; }], ['AcnAuditeeId', function () { return Serenity.IntegerEditor; }], ['AcnId', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(MasterAcnAuditeeRefForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditeeRefRow;
        (function (MasterAcnAuditeeRefRow) {
            MasterAcnAuditeeRefRow.idProperty = 'AcnAuditeeRefId';
            MasterAcnAuditeeRefRow.localTextPrefix = 'Administration.MasterAcnAuditeeRef';
            var Fields;
            (function (Fields) {
            })(Fields = MasterAcnAuditeeRefRow.Fields || (MasterAcnAuditeeRefRow.Fields = {}));
            ['AcnAuditeeRefId', 'AcnAuditeeId', 'AcnId'].forEach(function (x) { return Fields[x] = x; });
        })(MasterAcnAuditeeRefRow = Administration.MasterAcnAuditeeRefRow || (Administration.MasterAcnAuditeeRefRow = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditeeRefService;
        (function (MasterAcnAuditeeRefService) {
            MasterAcnAuditeeRefService.baseUrl = 'Administration/MasterAcnAuditeeRef';
            var Methods;
            (function (Methods) {
            })(Methods = MasterAcnAuditeeRefService.Methods || (MasterAcnAuditeeRefService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                MasterAcnAuditeeRefService[x] = function (r, s, o) { return Q.serviceRequest(MasterAcnAuditeeRefService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = MasterAcnAuditeeRefService.baseUrl + '/' + x;
            });
        })(MasterAcnAuditeeRefService = Administration.MasterAcnAuditeeRefService || (Administration.MasterAcnAuditeeRefService = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditorRefForm = (function (_super) {
            __extends(MasterAcnAuditorRefForm, _super);
            function MasterAcnAuditorRefForm() {
                _super.apply(this, arguments);
            }
            MasterAcnAuditorRefForm.formKey = 'Administration.MasterAcnAuditorRef';
            return MasterAcnAuditorRefForm;
        }(Serenity.PrefixedContext));
        Administration.MasterAcnAuditorRefForm = MasterAcnAuditorRefForm;
        [['AcnAuditorRefId', function () { return Serenity.IntegerEditor; }], ['AcnAuditorId', function () { return Serenity.IntegerEditor; }], ['AcnId', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(MasterAcnAuditorRefForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditorRefRow;
        (function (MasterAcnAuditorRefRow) {
            MasterAcnAuditorRefRow.idProperty = 'AcnAuditorRefId';
            MasterAcnAuditorRefRow.localTextPrefix = 'Administration.MasterAcnAuditorRef';
            var Fields;
            (function (Fields) {
            })(Fields = MasterAcnAuditorRefRow.Fields || (MasterAcnAuditorRefRow.Fields = {}));
            ['AcnAuditorRefId', 'AcnAuditorId', 'AcnId'].forEach(function (x) { return Fields[x] = x; });
        })(MasterAcnAuditorRefRow = Administration.MasterAcnAuditorRefRow || (Administration.MasterAcnAuditorRefRow = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditorRefService;
        (function (MasterAcnAuditorRefService) {
            MasterAcnAuditorRefService.baseUrl = 'Administration/MasterAcnAuditorRef';
            var Methods;
            (function (Methods) {
            })(Methods = MasterAcnAuditorRefService.Methods || (MasterAcnAuditorRefService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                MasterAcnAuditorRefService[x] = function (r, s, o) { return Q.serviceRequest(MasterAcnAuditorRefService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = MasterAcnAuditorRefService.baseUrl + '/' + x;
            });
        })(MasterAcnAuditorRefService = Administration.MasterAcnAuditorRefService || (Administration.MasterAcnAuditorRefService = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    ...
    (function (Administration) {
        ...
        [['Title', function () { return Serenity.StringEditor; }], ['Statusid', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(MasterAcnForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    ...
    (function (Administration) {
        ...
        (function (MasterAcnRow) {
            ...
            ['Id', 'Title', 'Statusid'].forEach(function (x) { return Fields[x] = x; });
...
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterscopeForm = (function (_super) {
            __extends(MasterscopeForm, _super);
            function MasterscopeForm() {
                _super.apply(this, arguments);
            }
            MasterscopeForm.formKey = 'Administration.Masterscope';
            return MasterscopeForm;
        }(Serenity.PrefixedContext));
        Administration.MasterscopeForm = MasterscopeForm;
        [['ScopeId', function () { return Serenity.IntegerEditor; }], ['Title', function () { return Serenity.StringEditor; }], ['AcnId', function () { return Serenity.IntegerEditor; }], ['Exclude', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(MasterscopeForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    ...
    (function (Administration) {
        var MasterscopeRow;
        (function (MasterscopeRow) {
            MasterscopeRow.idProperty = 'ScopeId';
            MasterscopeRow.nameProperty = 'Title';
            MasterscopeRow.localTextPrefix = 'Administration.Masterscope';
            var Fields;
            (function (Fields) {
            })(Fields = MasterscopeRow.Fields || (MasterscopeRow.Fields = {}));
            ['ScopeId', 'Title', 'AcnId', 'Exclude', 'AcnAcnTilte', 'AcnPhaseNo', 'AcnLocation', 'AcnFromdate', 'AcnTodate', 'AcnPeriodfrom', 'AcnPeriodto', 'AcnCreationdate', 'AcnUserid', 'AcnPreview', 'AcnSend', 'AcnMId', 'AcnStatus', 'AcnStatusid'].forEach(function (x) { return Fields[x] = x; });
        })(MasterscopeRow = Administration.MasterscopeRow || (Administration.MasterscopeRow = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterscopeService;
        (function (MasterscopeService) {
            MasterscopeService.baseUrl = 'Administration/Masterscope';
            var Methods;
            (function (Methods) {
            })(Methods = MasterscopeService.Methods || (MasterscopeService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                MasterscopeService[x] = function (r, s, o) { return Q.serviceRequest(MasterscopeService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = MasterscopeService.baseUrl + '/' + x;
            });
        })(MasterscopeService = Administration.MasterscopeService || (Administration.MasterscopeService = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var NewAcnMasterForm = (function (_super) {
            __extends(NewAcnMasterForm, _super);
            function NewAcnMasterForm() {
                _super.apply(this, arguments);
            }
            NewAcnMasterForm.formKey = 'Administration.NewAcnMaster';
            return NewAcnMasterForm;
        }(Serenity.PrefixedContext));
        Administration.NewAcnMasterForm = NewAcnMasterForm;
        [['Id', function () { return Serenity.IntegerEditor; }], ['AcnTilte', function () { return Serenity.StringEditor; }], ['PhaseNo', function () { return Serenity.IntegerEditor; }], ['Location', function () { return Serenity.StringEditor; }], ['Fromdate', function () { return Serenity.StringEditor; }], ['Todate', function () { return Serenity.StringEditor; }], ['Periodfrom', function () { return Serenity.StringEditor; }], ['Periodto', function () { return Serenity.StringEditor; }], ['Creationdate', function () { return Serenity.StringEditor; }], ['Userid', function () { return Serenity.IntegerEditor; }], ['Preview', function () { return Serenity.StringEditor; }], ['Send', function () { return Serenity.StringEditor; }], ['MId', function () { return Serenity.IntegerEditor; }], ['Status', function () { return Serenity.IntegerEditor; }], ['Statusid', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(NewAcnMasterForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    ...
    (function (Administration) {
        var NewAcnMasterRow;
        (function (NewAcnMasterRow) {
            NewAcnMasterRow.idProperty = 'Id';
            NewAcnMasterRow.nameProperty = 'AcnTilte';
            NewAcnMasterRow.localTextPrefix = 'Administration.NewAcnMaster';
            var Fields;
            (function (Fields) {
            })(Fields = NewAcnMasterRow.Fields || (NewAcnMasterRow.Fields = {}));
            ['Id', 'AcnTilte', 'PhaseNo', 'Location', 'Fromdate', 'Todate', 'Periodfrom', 'Periodto', 'Creationdate', 'Userid', 'Preview', 'Send', 'MId', 'Status', 'Statusid', 'UseridUsername', 'UseridDisplayName', 'UseridEmail', 'UseridSource', 'UseridPasswordHash', 'UseridPasswordSalt', 'UseridInsertDate', 'UseridInsertUserId', 'UseridUpdateDate', 'UseridUpdateUserId', 'UseridIsActive', 'UseridLastDirectoryUpdate', 'UseridRoleId'].forEach(function (x) { return Fields[x] = x; });
        })(NewAcnMasterRow = Administration.NewAcnMasterRow || (Administration.NewAcnMasterRow = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var NewAcnMasterService;
        (function (NewAcnMasterService) {
            NewAcnMasterService.baseUrl = 'Administration/NewAcnMaster';
            var Methods;
            (function (Methods) {
            })(Methods = NewAcnMasterService.Methods || (NewAcnMasterService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                NewAcnMasterService[x] = function (r, s, o) { return Q.serviceRequest(NewAcnMasterService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = NewAcnMasterService.baseUrl + '/' + x;
            });
        })(NewAcnMasterService = Administration.NewAcnMasterService || (Administration.NewAcnMasterService = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var PendingAcnForm = (function (_super) {
            __extends(PendingAcnForm, _super);
            function PendingAcnForm() {
                _super.apply(this, arguments);
            }
            PendingAcnForm.formKey = 'Administration.PendingAcn';
            return PendingAcnForm;
        }(Serenity.PrefixedContext));
        Administration.PendingAcnForm = PendingAcnForm;
        [['Title', function () { return Serenity.StringEditor; }], ['Statusid', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(PendingAcnForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    ...
    (function (Administration) {
        var PendingAcnRow;
        (function (PendingAcnRow) {
            PendingAcnRow.idProperty = 'Id';
            PendingAcnRow.nameProperty = 'Title';
            PendingAcnRow.localTextPrefix = 'Administration.PendingAcn';
            var Fields;
            (function (Fields) {
            })(Fields = PendingAcnRow.Fields || (PendingAcnRow.Fields = {}));
            ['Id', 'Title', 'Statusid'].forEach(function (x) { return Fields[x] = x; });
        })(PendingAcnRow = Administration.PendingAcnRow || (Administration.PendingAcnRow = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var PendingAcnService;
        (function (PendingAcnService) {
            PendingAcnService.baseUrl = 'Administration/PendingAcn';
            var Methods;
            (function (Methods) {
            })(Methods = PendingAcnService.Methods || (PendingAcnService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                PendingAcnService[x] = function (r, s, o) { return Q.serviceRequest(PendingAcnService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = PendingAcnService.baseUrl + '/' + x;
            });
        })(PendingAcnService = Administration.PendingAcnService || (Administration.PendingAcnService = {}));
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    ...
    (function (Adminstration) {
        var LocationForm = (function (_super) {
            ...
            LocationForm.formKey = 'Adminstration.Location';
            return LocationForm;
        }(Serenity.PrefixedContext));
        Adminstration.LocationForm = LocationForm;
        [['Locid', function () { return Serenity.IntegerEditor; }], ['Locname', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(LocationForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Adminstration = coromendal.Adminstration || (coromendal.Adminstration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    ...
    (function (Adminstration) {
        ...
        (function (LocationRow) {
            LocationRow.idProperty = 'Locid';
            LocationRow.nameProperty = 'Locname';
            LocationRow.localTextPrefix = 'Adminstration.Location';
            var Fields;
            (function (Fields) {
            })(Fields = LocationRow.Fields || (LocationRow.Fields = {}));
            ['Locid', 'Locname'].forEach(function (x) { return Fields[x] = x; });
        })(LocationRow = Adminstration.LocationRow || (Adminstration.LocationRow = {}));
    })(Adminstration = coromendal.Adminstration || (coromendal.Adminstration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    ...
    (function (Adminstration) {
        var LocationService;
        (function (LocationService) {
            LocationService.baseUrl = 'Adminstration/Location';
            var Methods;
            (function (Methods) {
            })(Methods = LocationService.Methods || (LocationService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
        ...
        })(LocationService = Adminstration.LocationService || (Adminstration.LocationService = {}));
    })(Adminstration = coromendal.Adminstration || (coromendal.Adminstration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    var NewAcnMaster;
    (function (NewAcnMaster) {
        var NewAcnMasterForm = (function (_super) {
            __extends(NewAcnMasterForm, _super);
            function NewAcnMasterForm() {
                _super.apply(this, arguments);
            }
            NewAcnMasterForm.formKey = 'NewAcnMaster.NewAcnMaster';
            return NewAcnMasterForm;
        }(Serenity.PrefixedContext));
        NewAcnMaster.NewAcnMasterForm = NewAcnMasterForm;
        [['Id', function () { return Serenity.IntegerEditor; }], ['AcnTilte', function () { return Serenity.StringEditor; }], ['PhaseNo', function () { return Serenity.IntegerEditor; }], ['Location', function () { return Serenity.StringEditor; }], ['Fromdate', function () { return Serenity.StringEditor; }], ['Todate', function () { return Serenity.StringEditor; }], ['Periodfrom', function () { return Serenity.StringEditor; }], ['Periodto', function () { return Serenity.StringEditor; }], ['Creationdate', function () { return Serenity.StringEditor; }], ['Userid', function () { return Serenity.IntegerEditor; }], ['Preview', function () { return Serenity.StringEditor; }], ['Send', function () { return Serenity.StringEditor; }], ['MId', function () { return Serenity.IntegerEditor; }], ['Status', function () { return Serenity.IntegerEditor; }], ['Statusid', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(NewAcnMasterForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(NewAcnMaster = coromendal.NewAcnMaster || (coromendal.NewAcnMaster = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var NewAcnMaster;
    (function (NewAcnMaster) {
        ...
        (function (NewAcnMasterRow) {
            NewAcnMasterRow.idProperty = 'Id';
            NewAcnMasterRow.nameProperty = 'AcnTilte';
            NewAcnMasterRow.localTextPrefix = 'NewAcnMaster.NewAcnMaster';
            var Fields;
            (function (Fields) {
            })(Fields = NewAcnMasterRow.Fields || (NewAcnMasterRow.Fields = {}));
            ['Id', 'AcnTilte', 'PhaseNo', 'Location', 'Fromdate', 'Todate', 'Periodfrom', 'Periodto', 'Creationdate', 'Userid', 'Preview', 'Send', 'MId', 'Status', 'Statusid', 'UseridUsername', 'UseridDisplayName', 'UseridEmail', 'UseridSource', 'UseridPasswordHash', 'UseridPasswordSalt', 'UseridInsertDate', 'UseridInsertUserId', 'UseridUpdateDate', 'UseridUpdateUserId', 'UseridIsActive', 'UseridLastDirectoryUpdate', 'UseridRoleId'].forEach(function (x) { return Fields[x] = x; });
        })(NewAcnMasterRow = NewAcnMaster.NewAcnMasterRow || (NewAcnMaster.NewAcnMasterRow = {}));
    })(NewAcnMaster = coromendal.NewAcnMaster || (coromendal.NewAcnMaster = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    ...
    (function (NewAcnMaster) {
        var NewAcnMasterService;
        (function (NewAcnMasterService) {
            NewAcnMasterService.baseUrl = 'NewAcnMaster/NewAcnMaster';
            var Methods;
            (function (Methods) {
            })(Methods = NewAcnMasterService.Methods || (NewAcnMasterService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
        ...
        })(NewAcnMasterService = NewAcnMaster.NewAcnMasterService || (NewAcnMaster.NewAcnMasterService = {}));
    })(NewAcnMaster = coromendal.NewAcnMaster || (coromendal.NewAcnMaster = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var NewAcnMasterDialog = (function (_super) {
            __extends(NewAcnMasterDialog, _super);
            function NewAcnMasterDialog() {
                _super.apply(this, arguments);
                this.form = new Administration.NewAcnMasterForm(this.idPrefix);
            }
            NewAcnMasterDialog.prototype.getFormKey = function () { return Administration.NewAcnMasterForm.formKey; };
            NewAcnMasterDialog.prototype.getIdProperty = function () { return Administration.NewAcnMasterRow.idProperty; };
            NewAcnMasterDialog.prototype.getLocalTextPrefix = function () { return Administration.NewAcnMasterRow.localTextPrefix; };
            NewAcnMasterDialog.prototype.getNameProperty = function () { return Administration.NewAcnMasterRow.nameProperty; };
            NewAcnMasterDialog.prototype.getService = function () { return Administration.NewAcnMasterService.baseUrl; };
            NewAcnMasterDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], NewAcnMasterDialog);
            return NewAcnMasterDialog;
        }(Serenity.EntityDialog));
        Administration.NewAcnMasterDialog = NewAcnMasterDialog;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var NewAcnMasterEditor = (function (_super) {
            __extends(NewAcnMasterEditor, _super);
            function NewAcnMasterEditor(container) {
                _super.call(this, container);
            }
            NewAcnMasterEditor.prototype.getColumnsKey = function () { return 'Administration.NewAcnMaster'; };
            NewAcnMasterEditor.prototype.getDialogType = function () { return Administration.NewAcnMasterEditorDialog; };
            NewAcnMasterEditor.prototype.getLocalTextPrefix = function () { return Administration.NewAcnMasterRow.localTextPrefix; };
            NewAcnMasterEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], NewAcnMasterEditor);
            return NewAcnMasterEditor;
        }(coromendal.Common.GridEditorBase));
        Administration.NewAcnMasterEditor = NewAcnMasterEditor;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var NewAcnMasterEditorDialog = (function (_super) {
            __extends(NewAcnMasterEditorDialog, _super);
            function NewAcnMasterEditorDialog() {
                _super.apply(this, arguments);
                this.form = new Administration.NewAcnMasterForm(this.idPrefix);
            }
            NewAcnMasterEditorDialog.prototype.getFormKey = function () { return Administration.NewAcnMasterForm.formKey; };
            NewAcnMasterEditorDialog.prototype.getLocalTextPrefix = function () { return Administration.NewAcnMasterRow.localTextPrefix; };
            NewAcnMasterEditorDialog.prototype.getNameProperty = function () { return Administration.NewAcnMasterRow.nameProperty; };
            NewAcnMasterEditorDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], NewAcnMasterEditorDialog);
            return NewAcnMasterEditorDialog;
        }(coromendal.Common.GridEditorDialog));
        Administration.NewAcnMasterEditorDialog = NewAcnMasterEditorDialog;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var NewAcnMasterGrid = (function (_super) {
            __extends(NewAcnMasterGrid, _super);
            function NewAcnMasterGrid(container) {
                _super.call(this, container);
            }
            NewAcnMasterGrid.prototype.getColumnsKey = function () { return 'Administration.NewAcnMaster'; };
            NewAcnMasterGrid.prototype.getDialogType = function () { return Administration.NewAcnMasterDialog; };
            NewAcnMasterGrid.prototype.getIdProperty = function () { return Administration.NewAcnMasterRow.idProperty; };
            NewAcnMasterGrid.prototype.getLocalTextPrefix = function () { return Administration.NewAcnMasterRow.localTextPrefix; };
            NewAcnMasterGrid.prototype.getService = function () { return Administration.NewAcnMasterService.baseUrl; };
            NewAcnMasterGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                debugger;
            ...
            NewAcnMasterGrid.prototype.onClick = function (e, row, cell) {
                _super.prototype.onClick.call(this, e, row, cell);
                if (e.isDefaultPrevented()) {
                    return;
                }
            ...
            NewAcnMasterGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], NewAcnMasterGrid);
            return NewAcnMasterGrid;
        }(Serenity.EntityGrid));
        Administration.NewAcnMasterGrid = NewAcnMasterGrid;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterscopeDialog = (function (_super) {
            __extends(MasterscopeDialog, _super);
            function MasterscopeDialog() {
                _super.apply(this, arguments);
                this.form = new Administration.MasterscopeForm(this.idPrefix);
            }
            MasterscopeDialog.prototype.getFormKey = function () { return Administration.MasterscopeForm.formKey; };
            MasterscopeDialog.prototype.getIdProperty = function () { return Administration.MasterscopeRow.idProperty; };
            MasterscopeDialog.prototype.getLocalTextPrefix = function () { return Administration.MasterscopeRow.localTextPrefix; };
            MasterscopeDialog.prototype.getNameProperty = function () { return Administration.MasterscopeRow.nameProperty; };
            MasterscopeDialog.prototype.getService = function () { return Administration.MasterscopeService.baseUrl; };
            MasterscopeDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], MasterscopeDialog);
            return MasterscopeDialog;
        }(Serenity.EntityDialog));
        Administration.MasterscopeDialog = MasterscopeDialog;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterscopeEditor = (function (_super) {
            __extends(MasterscopeEditor, _super);
            function MasterscopeEditor(container) {
                _super.call(this, container);
            }
            MasterscopeEditor.prototype.getColumnsKey = function () { return 'Administration.Masterscope'; };
            MasterscopeEditor.prototype.getDialogType = function () { return Administration.MasterscopeEditorDialog; };
            MasterscopeEditor.prototype.getLocalTextPrefix = function () { return Administration.MasterscopeRow.localTextPrefix; };
            MasterscopeEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], MasterscopeEditor);
            return MasterscopeEditor;
        }(coromendal.Common.GridEditorBase));
        Administration.MasterscopeEditor = MasterscopeEditor;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterscopeEditorDialog = (function (_super) {
            __extends(MasterscopeEditorDialog, _super);
            function MasterscopeEditorDialog() {
                _super.apply(this, arguments);
                this.form = new Administration.MasterscopeForm(this.idPrefix);
            }
            MasterscopeEditorDialog.prototype.getFormKey = function () { return Administration.MasterscopeForm.formKey; };
            MasterscopeEditorDialog.prototype.getLocalTextPrefix = function () { return Administration.MasterscopeRow.localTextPrefix; };
            MasterscopeEditorDialog.prototype.getNameProperty = function () { return Administration.MasterscopeRow.nameProperty; };
            MasterscopeEditorDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], MasterscopeEditorDialog);
            return MasterscopeEditorDialog;
        }(coromendal.Common.GridEditorDialog));
        Administration.MasterscopeEditorDialog = MasterscopeEditorDialog;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterscopeGrid = (function (_super) {
            __extends(MasterscopeGrid, _super);
            function MasterscopeGrid(container) {
                _super.call(this, container);
            }
            MasterscopeGrid.prototype.getColumnsKey = function () { return 'Administration.Masterscope'; };
            MasterscopeGrid.prototype.getDialogType = function () { return Administration.MasterscopeDialog; };
            MasterscopeGrid.prototype.getIdProperty = function () { return Administration.MasterscopeRow.idProperty; };
            MasterscopeGrid.prototype.getLocalTextPrefix = function () { return Administration.MasterscopeRow.localTextPrefix; };
            MasterscopeGrid.prototype.getService = function () { return Administration.MasterscopeService.baseUrl; };
            MasterscopeGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], MasterscopeGrid);
            return MasterscopeGrid;
        }(Serenity.EntityGrid));
        Administration.MasterscopeGrid = MasterscopeGrid;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditorRefDialog = (function (_super) {
            __extends(MasterAcnAuditorRefDialog, _super);
            function MasterAcnAuditorRefDialog() {
                _super.apply(this, arguments);
                this.form = new Administration.MasterAcnAuditorRefForm(this.idPrefix);
            }
            MasterAcnAuditorRefDialog.prototype.getFormKey = function () { return Administration.MasterAcnAuditorRefForm.formKey; };
            MasterAcnAuditorRefDialog.prototype.getIdProperty = function () { return Administration.MasterAcnAuditorRefRow.idProperty; };
            MasterAcnAuditorRefDialog.prototype.getLocalTextPrefix = function () { return Administration.MasterAcnAuditorRefRow.localTextPrefix; };
            MasterAcnAuditorRefDialog.prototype.getService = function () { return Administration.MasterAcnAuditorRefService.baseUrl; };
            MasterAcnAuditorRefDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], MasterAcnAuditorRefDialog);
            return MasterAcnAuditorRefDialog;
        }(Serenity.EntityDialog));
        Administration.MasterAcnAuditorRefDialog = MasterAcnAuditorRefDialog;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditorRefEditor = (function (_super) {
            __extends(MasterAcnAuditorRefEditor, _super);
            function MasterAcnAuditorRefEditor(container) {
                _super.call(this, container);
            }
            MasterAcnAuditorRefEditor.prototype.getColumnsKey = function () { return 'Administration.MasterAcnAuditorRef'; };
            MasterAcnAuditorRefEditor.prototype.getDialogType = function () { return Administration.MasterAcnAuditorRefEditorDialog; };
            MasterAcnAuditorRefEditor.prototype.getLocalTextPrefix = function () { return Administration.MasterAcnAuditorRefRow.localTextPrefix; };
            MasterAcnAuditorRefEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], MasterAcnAuditorRefEditor);
            return MasterAcnAuditorRefEditor;
        }(coromendal.Common.GridEditorBase));
        Administration.MasterAcnAuditorRefEditor = MasterAcnAuditorRefEditor;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditorRefEditorDialog = (function (_super) {
            __extends(MasterAcnAuditorRefEditorDialog, _super);
            function MasterAcnAuditorRefEditorDialog() {
                _super.apply(this, arguments);
                this.form = new Administration.MasterAcnAuditorRefForm(this.idPrefix);
            }
            MasterAcnAuditorRefEditorDialog.prototype.getFormKey = function () { return Administration.MasterAcnAuditorRefForm.formKey; };
            MasterAcnAuditorRefEditorDialog.prototype.getLocalTextPrefix = function () { return Administration.MasterAcnAuditorRefRow.localTextPrefix; };
            MasterAcnAuditorRefEditorDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], MasterAcnAuditorRefEditorDialog);
            return MasterAcnAuditorRefEditorDialog;
        }(coromendal.Common.GridEditorDialog));
        Administration.MasterAcnAuditorRefEditorDialog = MasterAcnAuditorRefEditorDialog;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditorRefGrid = (function (_super) {
            __extends(MasterAcnAuditorRefGrid, _super);
            function MasterAcnAuditorRefGrid(container) {
                _super.call(this, container);
            }
            MasterAcnAuditorRefGrid.prototype.getColumnsKey = function () { return 'Administration.MasterAcnAuditorRef'; };
            MasterAcnAuditorRefGrid.prototype.getDialogType = function () { return Administration.MasterAcnAuditorRefDialog; };
            MasterAcnAuditorRefGrid.prototype.getIdProperty = function () { return Administration.MasterAcnAuditorRefRow.idProperty; };
            MasterAcnAuditorRefGrid.prototype.getLocalTextPrefix = function () { return Administration.MasterAcnAuditorRefRow.localTextPrefix; };
            MasterAcnAuditorRefGrid.prototype.getService = function () { return Administration.MasterAcnAuditorRefService.baseUrl; };
            MasterAcnAuditorRefGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], MasterAcnAuditorRefGrid);
            return MasterAcnAuditorRefGrid;
        }(Serenity.EntityGrid));
        Administration.MasterAcnAuditorRefGrid = MasterAcnAuditorRefGrid;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditeeRefDialog = (function (_super) {
            __extends(MasterAcnAuditeeRefDialog, _super);
            function MasterAcnAuditeeRefDialog() {
                _super.apply(this, arguments);
                this.form = new Administration.MasterAcnAuditeeRefForm(this.idPrefix);
            }
            MasterAcnAuditeeRefDialog.prototype.getFormKey = function () { return Administration.MasterAcnAuditeeRefForm.formKey; };
            MasterAcnAuditeeRefDialog.prototype.getIdProperty = function () { return Administration.MasterAcnAuditeeRefRow.idProperty; };
            MasterAcnAuditeeRefDialog.prototype.getLocalTextPrefix = function () { return Administration.MasterAcnAuditeeRefRow.localTextPrefix; };
            MasterAcnAuditeeRefDialog.prototype.getService = function () { return Administration.MasterAcnAuditeeRefService.baseUrl; };
            MasterAcnAuditeeRefDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], MasterAcnAuditeeRefDialog);
            return MasterAcnAuditeeRefDialog;
        }(Serenity.EntityDialog));
        Administration.MasterAcnAuditeeRefDialog = MasterAcnAuditeeRefDialog;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditeeRefEditor = (function (_super) {
            __extends(MasterAcnAuditeeRefEditor, _super);
            function MasterAcnAuditeeRefEditor(container) {
                _super.call(this, container);
            }
            MasterAcnAuditeeRefEditor.prototype.getColumnsKey = function () { return 'Administration.MasterAcnAuditeeRef'; };
            MasterAcnAuditeeRefEditor.prototype.getDialogType = function () { return Administration.MasterAcnAuditeeRefEditorDialog; };
            MasterAcnAuditeeRefEditor.prototype.getLocalTextPrefix = function () { return Administration.MasterAcnAuditeeRefRow.localTextPrefix; };
            MasterAcnAuditeeRefEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], MasterAcnAuditeeRefEditor);
            return MasterAcnAuditeeRefEditor;
        }(coromendal.Common.GridEditorBase));
        Administration.MasterAcnAuditeeRefEditor = MasterAcnAuditeeRefEditor;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditeeRefEditorDialog = (function (_super) {
            __extends(MasterAcnAuditeeRefEditorDialog, _super);
            function MasterAcnAuditeeRefEditorDialog() {
                _super.apply(this, arguments);
                this.form = new Administration.MasterAcnAuditeeRefForm(this.idPrefix);
            }
            MasterAcnAuditeeRefEditorDialog.prototype.getFormKey = function () { return Administration.MasterAcnAuditeeRefForm.formKey; };
            MasterAcnAuditeeRefEditorDialog.prototype.getLocalTextPrefix = function () { return Administration.MasterAcnAuditeeRefRow.localTextPrefix; };
            MasterAcnAuditeeRefEditorDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], MasterAcnAuditeeRefEditorDialog);
            return MasterAcnAuditeeRefEditorDialog;
        }(coromendal.Common.GridEditorDialog));
        Administration.MasterAcnAuditeeRefEditorDialog = MasterAcnAuditeeRefEditorDialog;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var MasterAcnAuditeeRefGrid = (function (_super) {
            __extends(MasterAcnAuditeeRefGrid, _super);
            function MasterAcnAuditeeRefGrid(container) {
                _super.call(this, container);
            }
            MasterAcnAuditeeRefGrid.prototype.getColumnsKey = function () { return 'Administration.MasterAcnAuditeeRef'; };
            MasterAcnAuditeeRefGrid.prototype.getDialogType = function () { return Administration.MasterAcnAuditeeRefDialog; };
            MasterAcnAuditeeRefGrid.prototype.getIdProperty = function () { return Administration.MasterAcnAuditeeRefRow.idProperty; };
            MasterAcnAuditeeRefGrid.prototype.getLocalTextPrefix = function () { return Administration.MasterAcnAuditeeRefRow.localTextPrefix; };
            MasterAcnAuditeeRefGrid.prototype.getService = function () { return Administration.MasterAcnAuditeeRefService.baseUrl; };
            MasterAcnAuditeeRefGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], MasterAcnAuditeeRefGrid);
            return MasterAcnAuditeeRefGrid;
        }(Serenity.EntityGrid));
        Administration.MasterAcnAuditeeRefGrid = MasterAcnAuditeeRefGrid;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    ...
    (function (Administration) {
        var MasterAcnGrid = (function (_super) {
            ...
            MasterAcnGrid.prototype.getColumns = function () {
                //alert(fld.Statusid);
                var columns = _super.prototype.getColumns.call(this);
                ...
                if (fld.Id == 1) {
                    alert(fld.Statusid);
                    Q.first(columns, function (x) { return x.field == fld.Statusid; }).format =
                        function (ctx) { return "<a href=\"\" class=\"pendingbtn\"></a>"; };
                }
                return columns;
            };
...
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var AdminListFormatter = (function () {
            function AdminListFormatter() {
            }
            AdminListFormatter.prototype.format = function (ctx) {
                var idList = ctx.value;
                if (!idList)
                    return "";
                var name = "";
            ...
            AdminListFormatter = __decorate([
                Serenity.Decorators.registerFormatter()
            ], AdminListFormatter);
            return AdminListFormatter;
        }());
        Administration.AdminListFormatter = AdminListFormatter;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var AdminstatusvalueDialog = (function (_super) {
            __extends(AdminstatusvalueDialog, _super);
            function AdminstatusvalueDialog() {
                _super.apply(this, arguments);
                this.form = new Administration.AdminstatusvalueForm(this.idPrefix);
            }
            AdminstatusvalueDialog.prototype.getFormKey = function () { return Administration.AdminstatusvalueForm.formKey; };
            AdminstatusvalueDialog.prototype.getIdProperty = function () { return Administration.AdminstatusvalueRow.idProperty; };
            AdminstatusvalueDialog.prototype.getLocalTextPrefix = function () { return Administration.AdminstatusvalueRow.localTextPrefix; };
            AdminstatusvalueDialog.prototype.getNameProperty = function () { return Administration.AdminstatusvalueRow.nameProperty; };
            AdminstatusvalueDialog.prototype.getService = function () { return Administration.AdminstatusvalueService.baseUrl; };
            AdminstatusvalueDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], AdminstatusvalueDialog);
            return AdminstatusvalueDialog;
        }(Serenity.EntityDialog));
        Administration.AdminstatusvalueDialog = AdminstatusvalueDialog;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var AdminstatusvalueEditor = (function (_super) {
            __extends(AdminstatusvalueEditor, _super);
            function AdminstatusvalueEditor(container) {
                _super.call(this, container);
            }
            AdminstatusvalueEditor.prototype.getColumnsKey = function () { return 'Administration.Adminstatusvalue'; };
            AdminstatusvalueEditor.prototype.getDialogType = function () { return Administration.AdminstatusvalueEditorDialog; };
            AdminstatusvalueEditor.prototype.getLocalTextPrefix = function () { return Administration.AdminstatusvalueRow.localTextPrefix; };
            AdminstatusvalueEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], AdminstatusvalueEditor);
            return AdminstatusvalueEditor;
        }(coromendal.Common.GridEditorBase));
        Administration.AdminstatusvalueEditor = AdminstatusvalueEditor;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var AdminstatusvalueEditorDialog = (function (_super) {
            __extends(AdminstatusvalueEditorDialog, _super);
            function AdminstatusvalueEditorDialog() {
                _super.apply(this, arguments);
                this.form = new Administration.AdminstatusvalueForm(this.idPrefix);
            }
            AdminstatusvalueEditorDialog.prototype.getFormKey = function () { return Administration.AdminstatusvalueForm.formKey; };
            AdminstatusvalueEditorDialog.prototype.getLocalTextPrefix = function () { return Administration.AdminstatusvalueRow.localTextPrefix; };
            AdminstatusvalueEditorDialog.prototype.getNameProperty = function () { return Administration.AdminstatusvalueRow.nameProperty; };
            AdminstatusvalueEditorDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], AdminstatusvalueEditorDialog);
            return AdminstatusvalueEditorDialog;
        }(coromendal.Common.GridEditorDialog));
        Administration.AdminstatusvalueEditorDialog = AdminstatusvalueEditorDialog;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var Administration;
    (function (Administration) {
        var AdminstatusvalueGrid = (function (_super) {
            __extends(AdminstatusvalueGrid, _super);
            function AdminstatusvalueGrid(container) {
                _super.call(this, container);
            }
            AdminstatusvalueGrid.prototype.getColumnsKey = function () { return 'Administration.Adminstatusvalue'; };
            AdminstatusvalueGrid.prototype.getDialogType = function () { return Administration.AdminstatusvalueDialog; };
            AdminstatusvalueGrid.prototype.getIdProperty = function () { return Administration.AdminstatusvalueRow.idProperty; };
            AdminstatusvalueGrid.prototype.getLocalTextPrefix = function () { return Administration.AdminstatusvalueRow.localTextPrefix; };
            AdminstatusvalueGrid.prototype.getService = function () { return Administration.AdminstatusvalueService.baseUrl; };
            AdminstatusvalueGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], AdminstatusvalueGrid);
            return AdminstatusvalueGrid;
        }(Serenity.EntityGrid));
        Administration.AdminstatusvalueGrid = AdminstatusvalueGrid;
    })(Administration = coromendal.Administration || (coromendal.Administration = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ScopeexcludeDialog = (function (_super) {
            __extends(ScopeexcludeDialog, _super);
            function ScopeexcludeDialog() {
                _super.apply(this, arguments);
                this.form = new ACN.ScopeexcludeForm(this.idPrefix);
            }
            ScopeexcludeDialog.prototype.getFormKey = function () { return ACN.ScopeexcludeForm.formKey; };
            ScopeexcludeDialog.prototype.getIdProperty = function () { return ACN.ScopeexcludeRow.idProperty; };
            ScopeexcludeDialog.prototype.getLocalTextPrefix = function () { return ACN.ScopeexcludeRow.localTextPrefix; };
            ScopeexcludeDialog.prototype.getService = function () { return ACN.ScopeexcludeService.baseUrl; };
            ScopeexcludeDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], ScopeexcludeDialog);
            return ScopeexcludeDialog;
        }(Serenity.EntityDialog));
        ACN.ScopeexcludeDialog = ScopeexcludeDialog;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ScopeexcludeEditor = (function (_super) {
            __extends(ScopeexcludeEditor, _super);
            function ScopeexcludeEditor(container) {
                _super.call(this, container);
            }
            ScopeexcludeEditor.prototype.getColumnsKey = function () { return 'ACN.Scopeexclude'; };
            ScopeexcludeEditor.prototype.getDialogType = function () { return ACN.ScopeexcludeEditorDialog; };
            ScopeexcludeEditor.prototype.getLocalTextPrefix = function () { return ACN.ScopeexcludeRow.localTextPrefix; };
            ScopeexcludeEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], ScopeexcludeEditor);
            return ScopeexcludeEditor;
        }(coromendal.Common.GridEditorBase));
        ACN.ScopeexcludeEditor = ScopeexcludeEditor;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ScopeexcludeEditorDialog = (function (_super) {
            __extends(ScopeexcludeEditorDialog, _super);
            function ScopeexcludeEditorDialog() {
                _super.apply(this, arguments);
                this.form = new ACN.ScopeexcludeForm(this.idPrefix);
            }
            ScopeexcludeEditorDialog.prototype.getFormKey = function () { return ACN.ScopeexcludeForm.formKey; };
            ScopeexcludeEditorDialog.prototype.getLocalTextPrefix = function () { return ACN.ScopeexcludeRow.localTextPrefix; };
            ScopeexcludeEditorDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], ScopeexcludeEditorDialog);
            return ScopeexcludeEditorDialog;
        }(coromendal.Common.GridEditorDialog));
        ACN.ScopeexcludeEditorDialog = ScopeexcludeEditorDialog;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ScopeexcludeGrid = (function (_super) {
            __extends(ScopeexcludeGrid, _super);
            function ScopeexcludeGrid(container) {
                _super.call(this, container);
            }
            ScopeexcludeGrid.prototype.getColumnsKey = function () { return 'ACN.Scopeexclude'; };
            ScopeexcludeGrid.prototype.getDialogType = function () { return ACN.ScopeexcludeDialog; };
            ScopeexcludeGrid.prototype.getIdProperty = function () { return ACN.ScopeexcludeRow.idProperty; };
            ScopeexcludeGrid.prototype.getLocalTextPrefix = function () { return ACN.ScopeexcludeRow.localTextPrefix; };
            ScopeexcludeGrid.prototype.getService = function () { return ACN.ScopeexcludeService.baseUrl; };
            ScopeexcludeGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], ScopeexcludeGrid);
            return ScopeexcludeGrid;
        }(Serenity.EntityGrid));
        ACN.ScopeexcludeGrid = ScopeexcludeGrid;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ScopeFormatter = (function () {
            function ScopeFormatter() {
            }
            ScopeFormatter.prototype.format = function (ctx) {
                var idList = ctx.value;
                if (!idList)
                    return "";
                var name = "";
                var byId = ACN.ScopeRow.getLookup().itemById;
                for (var key in byId) {
            ...
            ScopeFormatter = __decorate([
                Serenity.Decorators.registerFormatter()
            ], ScopeFormatter);
            return ScopeFormatter;
        }());
        ACN.ScopeFormatter = ScopeFormatter;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var PreobservationDialog = (function (_super) {
            __extends(PreobservationDialog, _super);
            function PreobservationDialog() {
                _super.apply(this, arguments);
                this.form = new ACN.PreobservationForm(this.idPrefix);
            }
            PreobservationDialog.prototype.getFormKey = function () { return ACN.PreobservationForm.formKey; };
            PreobservationDialog.prototype.getIdProperty = function () { return ACN.PreobservationRow.idProperty; };
            ...
            PreobservationDialog.prototype.afterLoadEntity = function () {
                ...
                var id = Q.first(ACN.AuditobservationRow.getLookup().items, function (x) { return x.AuditobservationId == _this.form.Observationid.value; }).AuditobservationId;
            ...
            PreobservationDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], PreobservationDialog);
            return PreobservationDialog;
        }(Serenity.EntityDialog));
        ACN.PreobservationDialog = PreobservationDialog;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var PreobservationEditor = (function (_super) {
            __extends(PreobservationEditor, _super);
            function PreobservationEditor(container) {
                _super.call(this, container);
            }
            PreobservationEditor.prototype.getColumnsKey = function () { return 'ACN.Preobservation'; };
            PreobservationEditor.prototype.getDialogType = function () { return ACN.PreobservationEditorDialog; };
            PreobservationEditor.prototype.getLocalTextPrefix = function () { return ACN.PreobservationRow.localTextPrefix; };
            PreobservationEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], PreobservationEditor);
            return PreobservationEditor;
        }(coromendal.Common.GridEditorBase));
        ACN.PreobservationEditor = PreobservationEditor;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var PreobservationEditorDialog = (function (_super) {
            __extends(PreobservationEditorDialog, _super);
            function PreobservationEditorDialog() {
                _super.apply(this, arguments);
                this.form = new ACN.PreobservationForm(this.idPrefix);
            }
            PreobservationEditorDialog.prototype.getFormKey = function () { return ACN.PreobservationForm.formKey; };
            PreobservationEditorDialog.prototype.getLocalTextPrefix = function () { return ACN.PreobservationRow.localTextPrefix; };
            PreobservationEditorDialog.prototype.getNameProperty = function () { return ACN.PreobservationRow.nameProperty; };
            PreobservationEditorDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], PreobservationEditorDialog);
            return PreobservationEditorDialog;
        }(coromendal.Common.GridEditorDialog));
        ACN.PreobservationEditorDialog = PreobservationEditorDialog;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var PreobservationGrid = (function (_super) {
            __extends(PreobservationGrid, _super);
            function PreobservationGrid(container) {
                _super.call(this, container);
            }
            PreobservationGrid.prototype.getColumnsKey = function () { return 'ACN.Preobservation'; };
            PreobservationGrid.prototype.getDialogType = function () { return ACN.PreobservationDialog; };
            PreobservationGrid.prototype.getIdProperty = function () { return ACN.PreobservationRow.idProperty; };
            PreobservationGrid.prototype.getLocalTextPrefix = function () { return ACN.PreobservationRow.localTextPrefix; };
            PreobservationGrid.prototype.getService = function () { return ACN.PreobservationService.baseUrl; };
            PreobservationGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], PreobservationGrid);
            return PreobservationGrid;
        }(Serenity.EntityGrid));
        ACN.PreobservationGrid = PreobservationGrid;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ObservationmasterDialog = (function (_super) {
            __extends(ObservationmasterDialog, _super);
            function ObservationmasterDialog() {
                _super.apply(this, arguments);
                this.form = new ACN.ObservationmasterForm(this.idPrefix);
            }
            ObservationmasterDialog.prototype.getFormKey = function () { return ACN.ObservationmasterForm.formKey; };
            ObservationmasterDialog.prototype.getIdProperty = function () { return ACN.ObservationmasterRow.idProperty; };
            ObservationmasterDialog.prototype.getLocalTextPrefix = function () { return ACN.ObservationmasterRow.localTextPrefix; };
            ObservationmasterDialog.prototype.getNameProperty = function () { return ACN.ObservationmasterRow.nameProperty; };
            ObservationmasterDialog.prototype.getService = function () { return ACN.ObservationmasterService.baseUrl; };
            ObservationmasterDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], ObservationmasterDialog);
            return ObservationmasterDialog;
        }(Serenity.EntityDialog));
        ACN.ObservationmasterDialog = ObservationmasterDialog;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ObservationmasterEditor = (function (_super) {
            __extends(ObservationmasterEditor, _super);
            function ObservationmasterEditor(container) {
                _super.call(this, container);
            }
            ObservationmasterEditor.prototype.getColumnsKey = function () { return 'ACN.Observationmaster'; };
            ObservationmasterEditor.prototype.getDialogType = function () { return ACN.ObservationmasterEditorDialog; };
            ObservationmasterEditor.prototype.getLocalTextPrefix = function () { return ACN.ObservationmasterRow.localTextPrefix; };
            ObservationmasterEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], ObservationmasterEditor);
            return ObservationmasterEditor;
        }(coromendal.Common.GridEditorBase));
        ACN.ObservationmasterEditor = ObservationmasterEditor;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ObservationmasterEditorDialog = (function (_super) {
            __extends(ObservationmasterEditorDialog, _super);
            function ObservationmasterEditorDialog() {
                _super.apply(this, arguments);
                this.form = new ACN.ObservationmasterForm(this.idPrefix);
            }
            ObservationmasterEditorDialog.prototype.getFormKey = function () { return ACN.ObservationmasterForm.formKey; };
            ObservationmasterEditorDialog.prototype.getLocalTextPrefix = function () { return ACN.ObservationmasterRow.localTextPrefix; };
            ObservationmasterEditorDialog.prototype.getNameProperty = function () { return ACN.ObservationmasterRow.nameProperty; };
            ObservationmasterEditorDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], ObservationmasterEditorDialog);
            return ObservationmasterEditorDialog;
        }(coromendal.Common.GridEditorDialog));
        ACN.ObservationmasterEditorDialog = ObservationmasterEditorDialog;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ObservationmasterGrid = (function (_super) {
            __extends(ObservationmasterGrid, _super);
            function ObservationmasterGrid(container) {
                _super.call(this, container);
            }
            ObservationmasterGrid.prototype.getColumnsKey = function () { return 'ACN.Observationmaster'; };
            ObservationmasterGrid.prototype.getDialogType = function () { return ACN.ObservationmasterDialog; };
            ObservationmasterGrid.prototype.getIdProperty = function () { return ACN.ObservationmasterRow.idProperty; };
            ObservationmasterGrid.prototype.getLocalTextPrefix = function () { return ACN.ObservationmasterRow.localTextPrefix; };
            ObservationmasterGrid.prototype.getService = function () { return ACN.ObservationmasterService.baseUrl; };
            ObservationmasterGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], ObservationmasterGrid);
            return ObservationmasterGrid;
        }(Serenity.EntityGrid));
        ACN.ObservationmasterGrid = ObservationmasterGrid;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
...
(function (coromendal) {
    ...
    (function (ACN) {
        var FinalreportGrid = (function (_super) {
            ...
            FinalreportGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
            ...
            FinalreportGrid.prototype.onClick = function (e, row, cell) {
            ...
            FinalreportGrid.prototype.preview = function (respose) {
                //debugger;
                var total = respose[2];
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var consqFormatter = (function () {
            function consqFormatter() {
            }
            consqFormatter.prototype.format = function (ctx) {
                var idList = ctx.value;
                if (!idList)
                    return "";
                var name = "";
                var byId = ACN.RiskratingRow.getLookup().itemById;
                for (var key in byId) {
            ...
            consqFormatter = __decorate([
                Serenity.Decorators.registerFormatter()
            ], consqFormatter);
            return consqFormatter;
        }());
        ACN.consqFormatter = consqFormatter;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var FinalobservationDialog = (function (_super) {
            __extends(FinalobservationDialog, _super);
            function FinalobservationDialog() {
                _super.apply(this, arguments);
                this.form = new ACN.FinalobservationForm(this.idPrefix);
            }
            FinalobservationDialog.prototype.getFormKey = function () { return ACN.FinalobservationForm.formKey; };
            FinalobservationDialog.prototype.getIdProperty = function () { return ACN.FinalobservationRow.idProperty; };
            FinalobservationDialog.prototype.getLocalTextPrefix = function () { return ACN.FinalobservationRow.localTextPrefix; };
            FinalobservationDialog.prototype.getNameProperty = function () { return ACN.FinalobservationRow.nameProperty; };
            FinalobservationDialog.prototype.getService = function () { return ACN.FinalobservationService.baseUrl; };
            FinalobservationDialog.prototype.setCustomerDetail = function (details) {
                this.form.SuggestionList.value = details.SuggestionList;
                this.form.rootList.value = details.rootList;
                this.form.Detailedobservation1.value = details.Detailedobservation1;
                this.form.Name.value = details.Name;
            ...
            FinalobservationDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], FinalobservationDialog);
            return FinalobservationDialog;
        }(Serenity.EntityDialog));
        ACN.FinalobservationDialog = FinalobservationDialog;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var FinalobservationEditor = (function (_super) {
            __extends(FinalobservationEditor, _super);
            function FinalobservationEditor(container) {
                _super.call(this, container);
            }
            FinalobservationEditor.prototype.getColumnsKey = function () { return 'ACN.Finalobservation'; };
            FinalobservationEditor.prototype.getDialogType = function () { return ACN.FinalobservationEditorDialog; };
            FinalobservationEditor.prototype.getLocalTextPrefix = function () { return ACN.FinalobservationRow.localTextPrefix; };
            FinalobservationEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], FinalobservationEditor);
            return FinalobservationEditor;
        }(coromendal.Common.GridEditorBase));
        ACN.FinalobservationEditor = FinalobservationEditor;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var FinalobservationEditorDialog = (function (_super) {
            __extends(FinalobservationEditorDialog, _super);
            function FinalobservationEditorDialog() {
                _super.apply(this, arguments);
                this.form = new ACN.FinalobservationForm(this.idPrefix);
            }
            FinalobservationEditorDialog.prototype.getFormKey = function () { return ACN.FinalobservationForm.formKey; };
            FinalobservationEditorDialog.prototype.getLocalTextPrefix = function () { return ACN.FinalobservationRow.localTextPrefix; };
            FinalobservationEditorDialog.prototype.getNameProperty = function () { return ACN.FinalobservationRow.nameProperty; };
            FinalobservationEditorDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], FinalobservationEditorDialog);
            return FinalobservationEditorDialog;
        }(coromendal.Common.GridEditorDialog));
        ACN.FinalobservationEditorDialog = FinalobservationEditorDialog;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var FinalobservationGrid = (function (_super) {
            __extends(FinalobservationGrid, _super);
            function FinalobservationGrid(container) {
                _super.call(this, container);
            }
            FinalobservationGrid.prototype.getColumnsKey = function () { return 'ACN.Finalobservation'; };
            FinalobservationGrid.prototype.getDialogType = function () { return ACN.FinalobservationDialog; };
            FinalobservationGrid.prototype.getIdProperty = function () { return ACN.FinalobservationRow.idProperty; };
            FinalobservationGrid.prototype.getLocalTextPrefix = function () { return ACN.FinalobservationRow.localTextPrefix; };
            FinalobservationGrid.prototype.getService = function () { return ACN.FinalobservationService.baseUrl; };
            FinalobservationGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], FinalobservationGrid);
            return FinalobservationGrid;
        }(Serenity.EntityGrid));
        ACN.FinalobservationGrid = FinalobservationGrid;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
var coromendal;
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var likeFormatter = (function () {
            function likeFormatter() {
            }
            likeFormatter.prototype.format = function (ctx) {
                var idList = ctx.value;
                alert(idList);
                if (!idList)
                    return "";
                var name = "";
                var byId = ACN.LikeliwoodvalueRow.getLookup().itemById;
                for (var key in byId) {
...
(function (coromendal) {
    ...
    (function (ACN) {
        var CurrentauditobservationDialog = (function (_super) {
            ...
            CurrentauditobservationDialog.prototype.afterLoadEntity = function () {
                alert("hi");
            };
    ...
    (function (ACN) {
        var AuditobservationDialog = (function (_super) {
            ...
            function AuditobservationDialog() {
                ...
                this.form.Likelihood.changeSelect2(function (e) {
                    // alert("hi");
...
(function (coromendal) {
    ...
    (function (ACN) {
        var AuditobservationGrid = (function (_super) {
            ...
            AuditobservationGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = ACN.AuditobservationRow.Fields;
                if ((coromendal.Authorization.userDefinition.RoleId == 4) || (coromendal.Authorization.userDefinition.RoleId == 1)) {
                    Q.first(columns, function (x) { return x.field == fld.Agreeobservation; }).format =
                        function (ctx) { return "<a href=\"\" class=\"send sendbtn\"></a>"; };
                }
                Q.first(columns, function (x) { return x.field == fld.Suggestion; }).format =
                    function (ctx) { return "<a href=\"\" class=\"send releasebtn\"></a>"; };
                return columns;
            };
            AuditobservationGrid.prototype.onClick = function (e, row, cell) {
                _super.prototype.onClick.call(this, e, row, cell);
                if (e.isDefaultPrevented()) {
                    return;
                }
            ...
            AuditobservationGrid.prototype.preview = function (respose) {
                Q.iframeDialog({ html: respose });
                // console.log(respose);        
            };
...
(function (coromendal) {
    ...
    (function (ACN) {
        var AodDialog = (function (_super) {
            ...
            AodDialog.prototype.setCustomerDetail = function (details) {
                debugger;
                this.form.Areaofscope.value = details.ScopeList;
            };
            AodDialog.prototype.afterLoadEntity = function () {
                var _this = this;
                if (this.form.Acnid.value == 0) {
                    this.setCustomerDetail({});
                    return;
                }
                var id = Q.first(ACN.AcnRow.getLookup().items, function (x) { return x.AcnId == _this.form.Acnid.value; }).AcnId;
                ACN.AcnService.Retrieve({
                    EntityId: id
                }, function (response) {
                    _this.setCustomerDetail(response.Entity);
...
(function (coromendal) {
    ...
    (function (ACN) {
        var AcnreportDialog = (function (_super) {
            ...
            AcnreportDialog.prototype.setMeetingDetails = function () {
                //
                //alert("hi");
    ...
    (function (ACN) {
        var AcnreportGrid = (function (_super) {
            ...
            AcnreportGrid.prototype.getColumns = function () {
                ...
                var fld = ACN.AcnreportRow.Fields;
                Q.first(columns, function (x) { return x.field == fld.status; }).format =
                    function (ctx) { return "<div class=\"previewbtn\"></div>"; };
                Q.first(columns, function (x) { return x.field == fld.Download; }).format =
                    function (ctx) { return "<div class=\"down-button\"></div>"; };
                return columns;
            };
...
(function (coromendal) {
    var ACN;
    (function (ACN) {
        var ACNNameFormatter = (function () {
            function ACNNameFormatter() {
            }
            ACNNameFormatter.prototype.format = function (ctx) {
                var idList = ctx.value;
                if (!idList)
                    return "";
                var name = "";
                var byId = ACN.AcnRow.getLookup().itemById;
                for (var key in byId) {
            ...
            ACNNameFormatter = __decorate([
                Serenity.Decorators.registerFormatter()
            ], ACNNameFormatter);
            return ACNNameFormatter;
        }());
        ACN.ACNNameFormatter = ACNNameFormatter;
    })(ACN = coromendal.ACN || (coromendal.ACN = {}));
})(coromendal || (coromendal = {}));
